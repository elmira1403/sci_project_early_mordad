...
public class SignUpActivity extends AppCompatActivity {
            ...
            public void onClick(View view) {
                ...
                if (isValidPassword(password)) {
                    ...
                    if (password.equals(confirm_password_edit.getText().toString())) {
                        ...
                        Toast.makeText(SignUpActivity.this, ir.elmirayafteh.spinalcordinjury.sci.R.string.passwords_dont_match, Toast.LENGTH_LONG).show();
                    ...
                    mResult.setListener(new MyPreferences.RetroResultListener() {
                        ...
                        public void onDataLoaded(String result) {
                            if (Boolean.parseBoolean(result)) {
                                ...
                                intent.putExtra("caller", "sign_up");
    ...
    public void savePreferences() {
        ...
        editor.putString("gender", gender_btn.getText().toString());
