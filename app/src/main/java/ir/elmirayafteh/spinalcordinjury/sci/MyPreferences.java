...
public class MyPreferences {
    ...
    public void saveOnServer() {
        ...
        uService.registerUser(phone_number, password, email, birthday, gender, sci_type, experience_level,
    ...
    public Boolean updateOnServer() {
        ...
        uService.updateUser(phone_number, email, birthday, gender, sci_type, experience_level,
                upper_strength, h_real, w_real, height, fitness).enqueue(new Callback<String>() {
