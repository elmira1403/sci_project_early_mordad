...
public class EditProfileActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sex_sp = (Spinner) findViewById(R.id.sexSpinner);
        ...
        sex_sp.setSelection(getIndex(sex_sp, pref.getString("sex", null)));
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                editor.putString("sex", sex_sp.getSelectedItem().toString());
                ...
                editor.putString("height", h_convert.ConvertHeight(h_real, sex_sp.getSelectedItem().toString()));
                editor.putString("fitness", f_calc.FitnessCalc(h_real, w_real, age, sex_sp.getSelectedItem().toString()));

                if (b_email && b_dob && b_height && b_weight) {
                    fab.setImageResource(R.drawable.approved_checkmark_48_2);
                    editor.apply();
                    ...
                    new Handler().postDelayed(new Runnable() {
                        @Override
                        public void run() {
                            fab.setImageResource(R.drawable.checkmark_48);
                        }
                    }, 5000);
