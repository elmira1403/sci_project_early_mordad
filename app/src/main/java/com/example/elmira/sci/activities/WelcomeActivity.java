...
public class WelcomeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (mUsername != null && mPassword != null && !mUsername.isEmpty() && !mPassword.isEmpty()) {
            ...
            uService.getUserInfo(mUsername).enqueue(new Callback<UserInfo>() {
                @Override
                public void onResponse(Call<UserInfo> call, Response<UserInfo> response) {
                    if (response.isSuccessful()) {
                        ...
                        if (!mUserInfo.user_exist.equals("not_exist")) {
                            ...
                            if (mPassword.equals(mUserInfo.password)) {
            ...
            public void onClick(View view) {
                ...
                btnSignIn2.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        uService.getUserInfo(phoneNumber).enqueue(new Callback<UserInfo>() {
                            @Override
                            public void onResponse(Call<UserInfo> call, Response<UserInfo> response) {
                                if (response.isSuccessful()) {
                                    mUserInfo = response.body();
                                    ...
                                    if (!mUserInfo.user_exist.equals("not_exist")) {
                                        ...
                                        if (password.equals(mUserInfo.password)) {
                                            sharedpreferences = getSharedPreferences(USER, MODE_PRIVATE);
                                            ...
                                            Toast.makeText(WelcomeActivity.this, R.string.wrong_password, Toast.LENGTH_LONG).show();
                                        }
                                    } else {
                                        Toast.makeText(WelcomeActivity.this, R.string.account_error, Toast.LENGTH_LONG).show();
                                    }
                                }
                            }
                ...
                forgot_password.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        Toast.makeText(WelcomeActivity.this, "فراموشی رمز", Toast.LENGTH_LONG).show();
                ...
                btnSignUp2.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        if (isNumberValid(phoneNumber)) {
                            ...
                            Toast.makeText(WelcomeActivity.this, "ارسال پیامک", Toast.LENGTH_LONG).show();
                            ...
                            resend_code.setOnClickListener(new View.OnClickListener() {
                                @Override
                                public void onClick(View view) {
                                    Toast.makeText(WelcomeActivity.this, "ارسال مجدد کد", Toast.LENGTH_LONG).show();
                                }
                            });
