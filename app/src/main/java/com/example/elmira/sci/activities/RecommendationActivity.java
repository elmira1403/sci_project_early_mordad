...
import static com.example.elmira.sci.database.RecCaseDbSchema.SolutionTable.Cols.DESC;
import static com.example.elmira.sci.database.RecCaseDbSchema.SolutionTable.Cols.SUBJECT;
import static com.example.elmira.sci.database.RecCaseDbSchema.SolutionTable.Cols.TEXT;
...
public class RecommendationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayList<Case> data = new ArrayList<Case>();
